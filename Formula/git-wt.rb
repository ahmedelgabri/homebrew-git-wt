class GitWt < Formula
  ...
  on_macos do
    on_intel do
      ...
      sha256 "33ddd97e7dc085b60df1ae016fb230fb14866b18815d5f3c17d9fb0db5ed5b9c"
    end

    on_arm do
      url "https://github.com/ahmedelgabri/git-wt/releases/download/v#{version}/git-wt-#{version}-darwin-arm64.tar.gz"
      sha256 "0221359f28d22f43869923785b5ec639d09c8aa185699b24d6013aa2f6608e4d"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "b32da023bdd75e4089108b3a16f8e51593d39f359d236b3a002618b890029c01"
    end

    on_arm do
      url "https://github.com/ahmedelgabri/git-wt/releases/download/v#{version}/git-wt-#{version}-linux-arm64.tar.gz"
      sha256 "e9a928d12b6255269e8e625d09318c682c926f98a9498e7ab698d9f3686cdb36"
    end
  end
